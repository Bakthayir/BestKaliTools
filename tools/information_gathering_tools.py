...
class XeroSploit(BestKaliTools):
    TITLE = "Xerosploit"
...
class ReconSpider(BestKaliTools):
...
class SecretFinder(BestKaliTools):
...
class PortScannerRanger(BestKaliTools):
...
class InformationGatheringTools(BestKaliToolssCollection):
